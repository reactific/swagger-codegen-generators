...
public class ScalaAkkaHttpClientCodegen
    extends AbstractScalaCodegen implements CodegenConfig {
    ...
    /**
     * If set to true, only the default response (the one with le lowest 2XX
     * code) will be considered as a success, and all others as ApiErrors.
     * If set to false, all responses defined in the model will be considered
     * as a success upon reception. Only http errors,
     * unmarshalling problems and any other RuntimeException will be
     * considered as ApiErrors.
     */
    protected boolean onlyOneSuccess = true;

    @SuppressWarnings("hiding")
    protected Logger LOGGER = LoggerFactory.getLogger(io.swagger.codegen.languages.AkkaScalaClientCodegen.class);

    public ScalaAkkaHttpClientCodegen() {
        super();
    ...
    public String getHelp() {
        return "Generates a Scala client library (alpha) base on Akka Http.";
    }
    ...
    public String getArgumentsLocation() {
        return "/arguments/scala-akka-http-client.yaml";
    }
    ...
    private static class CamelizeLambda extends CustomLambda {
        ...
        private CamelizeLambda(boolean capitalizeFirst) {
